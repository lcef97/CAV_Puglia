...
```{r mixing mmod summary,  fig.height = 3, fig.cap = "Posterior marginal of the LCAR mixing parameter"}
...
```{r mixing mmod plot, fig.height = 3, fig.cap = "Posterior marginal of the BYM mixing parameters", echo = FALSE}
philimX <- range(0,1)
