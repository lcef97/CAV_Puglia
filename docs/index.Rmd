...
## A Sequential approach for the PC-prior  
  ...
  - Set up: $\pi(\theta) = \pi (\theta_1) \pi(\theta_2 \mid \theta_1) \dots \pi(\theta_k \mid \theta_1, \dots, \theta_{k-1})$
  
    - Provided that $\pi(\theta_j \mid \theta_1, \dots, \theta_{j-1}) = \pi(\theta_j \mid \theta_1, \theta_{j-1}, \theta_{j+1}=\dots=\theta_k=0)$
