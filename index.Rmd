...
$$
y_i \sim \mathrm{Poisson(e^{P_i} \lambda_i \pi_i)}
$$
Where $\lambda_i \in \mathbb{R}^{+}$ is the parameter controlling the occurrence of true counts, and $\pi_i \in [0,1]$ controls for reporting frequency. $P_i$ is the log-offset.
