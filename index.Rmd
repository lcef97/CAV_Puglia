...
alphas <- cbind(
  ...
  q0.975  = cav_bym_INLA$summary.fixed$`0.975quant`) , 3))#,
...
Perhaps, the biggest INLA-related weakness element is the impossibility to apply LOOCV by means of the CPO. This problematic is streeed out by the high rate of failure (221/256) in meeting the regularity conditions to compute CPOs, flagged by nonzero values in `inla$cpo$failure`. This issue could be partially mitigated by zero-inflated Poisson regression.
