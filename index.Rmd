...
:::{.only-html}
  -  $d$, i.e. the theoretical distance of each municipality from the municipality hosting the support center competent for that municipality. Distance is measured by road travel time in minutes.
Fo
