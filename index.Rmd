...
Here, we plot the access rate per residence municipality, i.e. the ratio between access counts and female population, both on the linear and the logarithmic scale. Blank areas in the latter figurecorrespond to municipalities from which zero women accessed support centers ($82$ municipalities).
...
hyperpars<- data.frame(rbind(cav_bym_INLA_marginals.var[c(1,3,5,7)],
  ...
  dplyr::mutate(Variable =c("Z_VAR_Pois", "Mixing_Pois", "Zero_Prob", "Z_VAR_ZIP", "Mixing_ZIP")) %>% 
