...
%we can arrange $\mathrm{vech} \Sigma$ as a vector of length $k(k+1)/2$ , and $( \sigma_1, \dots, \sigma_k, \rho_{12}, \dots \rho_{1k}, \rho_{23}, \rho_{2k} \dots \rho_{k-1, k} )$ as a vector of length $k(k+1)/2$ as well.
